...
#Function 1
def ConvertOdb2Vtk(filename = 'D:\ABA2018_workplace\odb2vtk\odb2vtk.txt'):  #Modify the default value of filename here to specify the default configuration file
